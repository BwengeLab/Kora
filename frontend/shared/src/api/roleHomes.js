export async function fetchOperatorDashboard(apiBaseUrl, token, signal) {
    return getJson(`${apiBaseUrl}/api/home/operator-dashboard`, token, signal);
}
export async function fetchAuditorDashboard(apiBaseUrl, token, signal) {
    return getJson(`${apiBaseUrl}/api/home/auditor-dashboard`, token, signal);
}
export async function fetchPlatformDashboard(apiBaseUrl, token, signal) {
    return getJson(`${apiBaseUrl}/api/home/platform-dashboard`, token, signal);
}
