...
export function registerCanonicalBlueprints() {
    if (registered)
        return;
...
export { auditorBlueprint, externalCollaboratorBlueprint, financeLeadBlueprint, financeOperatorBlueprint, orgAdminBlueprint, organizationOwnerBlueprint, superAdminBlueprint, };
