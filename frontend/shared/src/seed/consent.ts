...
export type ConsentScope = 'credit-passport' | 'bank-statements' | 'financials' | 'transactions' | 'contracts' | 'identity';

export interface ConsentGrant {
  id: string;
  grantee: string;
  granteeType: 'lender' | 'partner' | 'bureau' | 'auditor' | 'regulator';
  purpose: string;
  scopes: ConsentScope[];
...
export const CONSENT_STATUS_META: Record<ConsentStatus, { label: string; tone: string }> = {
...
export const seedConsents: ConsentGrant[] = [
