...
// ─── My tasks ──────────────────────────────────────────────────────────────
export type TaskStatus = 'assigned' | 'awaiting_info' | 'prepared' | 'returned';
...
export const seedOperatorTasks: OperatorTask[] = [
...
export interface AgentSuggestion {
  ...
  amount: Money;
  confidence: number;
  agent: 'Reconciliation' | 'Data Intake';
  summary: string;
}

export const seedAgentSuggestions: AgentSuggestion[] = [
...
// ─── Data intake batches ───────────────────────────────────────────────────
export type BatchStatus = 'processed' | 'processing' | 'needs_review';
...
export interface IntakeBatch {
  ...
  records: number;
  status: BatchStatus;
  flags: number; // data-quality flags
  when: string;
}

export const seedIntakeBatches: IntakeBatch[] = [
