...
const ev = (id, name, kind, sizeText, pageRef) => pageRef ? { id, name, kind, sizeText, pageRef } : { id, name, kind, sizeText };
const h = (id, at, actor, role, kind, action) => ({
    id,
    at,
    actor,
    actorRole: role,
...
export const seedApprovalTypeStats = [
